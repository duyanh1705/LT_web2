...
import com.nguyenduyanh.example05.entity.Address;
...
import com.nguyenduyanh.example05.payloads.AddressDTO;
import com.nguyenduyanh.example05.repository.AddressRepo;
import com.nguyenduyanh.example05.repository.UserRepo;
import com.nguyenduyanh.example05.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
    ...
    public AddressDTO updateAddress(Long addressId,Address address){
        Address addressFromDB = addressRepo.findByCountryAndStateAndCityAndPincodeAndStreetAndBuildingName(
            ...
            if(addressFromDB == null){
                addressFromDB = addressRepo.findById(addressId).orElseThrow(()-> new ResourceNotFoundException("Address","addressId",addressId));
